...
### CBow
- Wörter werden aus dem Kontext vorhergesagt
### Skip-Gram
- Kontext wird aus dem Wort vorhergesagt
### Transformer
- Attention is all you need -> Multihead attention 
- org. Encoder-Decoder Architektur
...
### Prozessdefinition
- sachlogische Folge von Aktivitäten, die der Erreichung der Unternehmensziele dienen
### Petri-Netze
- Modellierung von lokalen beschränkten, diskreten Prozessen
- häufig für Fertigung und Logistik
...
- grafische Methode zur Darstellung von Geschäftsprozessen
- Aktivitätssymbole, Entscheidungssymbole, Gateways, Konnektoren

### EPK
- Ereignisgesteuerte Prozesskette, weiter graphische Methode
- Ereignisse, Aktionen, Gateways, Verbindungen
